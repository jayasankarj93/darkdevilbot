...
import requests
from darkdevilbot import (DEV_USERS, OWNER_ID, SUDO_USERS, SUPPORT_USERS,
                          TIGER_USERS, WHITELIST_USERS, dispatcher, sw)
from darkdevilbot.__main__ import STATS, TOKEN, USER_INFO
from darkdevilbot.modules.disable import DisableAbleCommandHandler
from darkdevilbot.modules.helper_funcs.chat_status import sudo_plus, user_admin
