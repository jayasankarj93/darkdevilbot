...
from darkdevilbot.modules.helper_funcs.msg_types import Types
from darkdevilbot.modules.sql import BASE, SESSION
from sqlalchemy import (BigInteger, Boolean, Column, Integer, String,
                        UnicodeText)

DEFAULT_WELCOME = 'ഹായ് {first}, എവിടെ നിന്നാണ് ,നിങ്ങളെ പരിചയപ്പെടുത്താം?'
DEFAULT_GOODBYE = 'വന്നതിനു നന്ദി , വീണ്ടും വരിക '

DEFAULT_WELCOME_MESSAGES = [
    "{first} ന് സു - സ്വാഗതം ",  #Discord welcome messages copied
    "Genos, {first} is here.",
