...
import telegram
from darkdevilbot import BAN_STICKER, TIGER_USERS, WHITELIST_USERS, dispatcher
from darkdevilbot.modules.disable import DisableAbleCommandHandler
from darkdevilbot.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
...
from darkdevilbot.modules.helper_funcs.string_handling import split_quotes
from darkdevilbot.modules.log_channel import loggable
from darkdevilbot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # darkdevilbot's sticker
        keyboard = []
