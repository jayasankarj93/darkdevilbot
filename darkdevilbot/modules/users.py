...
import darkdevilbot.modules.sql.users_sql as sql
from darkdevilbot import DEV_USERS, LOGGER, OWNER_ID, dispatcher
from darkdevilbot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from darkdevilbot.modules.sql.users_sql import get_all_users
