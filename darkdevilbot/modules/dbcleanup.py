...
import darkdevilbot.modules.sql.global_bans_sql as gban_sql
import darkdevilbot.modules.sql.users_sql as user_sql
from darkdevilbot import DEV_USERS, OWNER_ID, dispatcher
