...
from darkdevilbot import (DEV_USERS, OWNER_ID, SUDO_USERS, SUPPORT_CHAT,
                          SUPPORT_USERS, TIGER_USERS, WHITELIST_USERS,
                          dispatcher)
from darkdevilbot.modules.helper_funcs.chat_status import (dev_plus, sudo_plus,
                                                           whitelist_plus)
from darkdevilbot.modules.helper_funcs.extraction import extract_user
from darkdevilbot.modules.log_channel import gloggable
from telegram import ParseMode, TelegramError, Update
from telegram.ext import CallbackContext, CommandHandler, run_async
from telegram.utils.helpers import mention_html

ELEVATED_USERS_FILE = os.path.join(os.getcwd(),
                                   'darkdevilbot/elevated_users.json')
...
disasters = """ darkdevilbot has bot access levels we call as *"Disaster Levels"*
...
\n*Dragons* - Have super user access, can gban, manage disasters lower than them and are admins in darkdevilbot.
...
\n*Disclaimer*: The disaster levels in darkdevilbot are there for troubleshooting, support, banning potential scammers.
