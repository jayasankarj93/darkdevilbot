...
from darkdevilbot.modules.sql.users_sql import get_user_com_chats
import darkdevilbot.modules.sql.global_bans_sql as sql
from darkdevilbot import (DEV_USERS, GBAN_LOGS, OWNER_ID, STRICT_GBAN,
...
from darkdevilbot.modules.helper_funcs.misc import send_to_list
from darkdevilbot.modules.sql.users_sql import get_all_chats
...
darkdevilbot also integrates @Spamwatch API into gbans to remove Spammers as much as possible from your chatroom!
*What is SpamWatch?*
