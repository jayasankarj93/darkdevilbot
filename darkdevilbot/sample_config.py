...
def get_user_list(config, key):
    with open('{}/darkdevilbot/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    API_HASH = "awoo"
    TOKEN = "BOT_TOKEN"
    OWNER_ID = 998920177  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "me_sreenta"
