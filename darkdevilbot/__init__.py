...
if ENV:
    ...
    from darkdevilbot.config import Development as Config
...
telethn = TelegramClient("darkdevilbot", API_ID, API_HASH)
...
from darkdevilbot.modules.helper_funcs.handlers import (CustomCommandHandler,
